      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-card mb-6 border border-[var(--border)] bg-[var(--background-card)]">
            <span className="text-cyan-500 font-bold mono text-sm">02.</span>
            <span className="text-sm text-[var(--text-body)]">Servicios</span>
          </div>
          ...
          {servicios.map((s, i) => (
            ...
            >
              ...
              >
                ...
                <h3 className="relative text-xl font-semibold mb-3 font-display text-[var(--text-title)]">{s.title}</h3>
                <p className="relative text-[var(--text-body)] text-base font-display leading-relaxed">{s.desc}</p>
              </div>
            </motion.div>
          ))}
        </div>
