...
export default function AdminHeader({ toggleSidebar, activeSection }: AdminHeaderProps) {
    return (
        <div className="admin-header">
            ...
            <div className="hidden lg:flex items-center bg-slate-800/50 rounded-none px-4 py-2 border border-white/5 w-96">
            ...
            <div className="header-actions">
                ...
                <button className="relative">
                    <FaEnvelope />
                    <span className="absolute top-2 right-2 w-2 h-2 bg-red-500 rounded-none border border-slate-900"></span>
                </button>
                <button className="relative">
                    <FaBell />
                    <span className="absolute top-2 right-2 w-2 h-2 bg-emerald-500 rounded-none border border-slate-900"></span>
                </button>
