            ...
            <div className="w-full lg:w-5/12 flex items-center justify-center p-8 lg:p-16 relative z-10 overflow-hidden">
                ...
                <div className="w-full max-w-md relative z-20">
                    <div className="mb-14">
                        ...
                        <h1 className="text-6xl lg:text-7xl font-black text-white mb-5 tracking-tighter leading-none select-none">
                            Next<br />Level
                            <span className="text-amber-500">.</span>
                        </h1>
                        <p className="text-amber-500/60 text-lg font-medium tracking-wide border-l-2 border-amber-600/30 pl-4 py-1">
                            Golden Protocol <span className="text-slate-700 font-black">2026</span>
                        </p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-10">
                        <div className="space-y-3">
                            <label className="text-[10px] uppercase text-amber-500/50 font-black tracking-[0.3em] ml-1">Identity Node</label>
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    placeholder="NODE_ACCESS@FJ.GOV"
                                />
                            </div>
                        </div>
                        ...
                        <div className="space-y-3">
                            <div className="flex justify-between items-center ml-1">
                                <label className="text-[10px] uppercase text-amber-500/50 font-black tracking-[0.3em]">Access Key</label>
                                <Link href="/auth/forgot-password" title="DECRYPT_ACCESS" className="text-[10px] uppercase text-slate-500 hover:text-amber-400 transition-all font-black tracking-widest">
                                    [ DECRYPT_LOGS ]
                                </Link>
                            </div>
                            <div className="relative group">
                    ...
                    <div className="mt-16 text-center border-t border-white/[0.03] pt-10">
                        <p className="text-slate-800 text-[10px] font-black tracking-[0.4em] uppercase">
                            Secured by <span className="text-amber-600 px-2">Favio Richar Labs</span>
                        </p>
                    </div>
                </div>
            </div>
